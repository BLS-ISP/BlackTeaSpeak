...
# We will decrypt using the old seed
seed = 13060217094303476911
...
print("\nFirst 100 decrypted bytes with old seed:")
print("  Hex:", decoded[:100].hex())

length_private_data = struct.unpack("<H", decoded[0:2])[0]
length_hierarchy = struct.unpack("<H", decoded[2:4])[0]
print(f"Parsed length_private_data: {length_private_data}")
print(f"Parsed length_hierarchy:    {length_hierarchy}")
