...
if target_file:
    print("Found license.cpp at:", target_file)
    with open(target_file, "r") as f:
        lines = f.readlines()
        
    # Find HierarchyEntry::read definition
    for idx, line in enumerate(lines):
        if "std::shared_ptr<HierarchyEntry> HierarchyEntry::read" in line or "HierarchyEntry::read(" in line:
