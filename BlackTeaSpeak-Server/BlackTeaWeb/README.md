# Official BlackTeaSpeak-Web Issue Tracker [![Build Status](https://travis-ci.org/BlackTeaSpeak/BlackTeaWeb.svg?branch=master)](https://travis-ci.org/BlackTeaSpeak/BlackTeaWeb)
...
2. People can see BlackTeaSpeak Web client progress and avoid creating repetitive issues all the time.
