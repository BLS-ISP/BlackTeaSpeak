...
export async function resolveBlackTeaSpeakServerAddress(address: DNSAddress, _options?: ResolveOptions) : Promise<DNSResolveResult> {
    try {
        const options = Object.assign({}, default_options);
        Object.assign(options, _options);

        const resolver = new BlackTeaSpeakDNSResolve(address);
