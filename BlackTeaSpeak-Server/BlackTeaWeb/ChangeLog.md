...
* **23.03.21**
    ...
    - Fixed issue [#74](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/74) (Swiss flag box has black background)
...
* **15.02.21**
    ...
    - Fixed issue [#169](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/169) (Adding permissions dosn't work for TS3 server)
    - Fixed issue [#166](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/166) (Private conversations are not accessible when IndexDB could not be opened)
...
* **22.12.20**
    ...
    - Fixed issue [#164](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/154) ("error: channel description" bug)
...
* **04.10.20**
    - Fixed invalid channel tree unique id assignment for the initial server entry ([#F2986](https://forum.blackteaspeak.de/index.php?threads/2986))
...
* **24.09.20**
    ...
    - Fixed issue [#139](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/139)
...
* **18.07.20**
    - Rewrote the channel conversation UI and manager
      ...
      - Automatically crawling all channels on server join for new messages (requires BlackTeaSpeak 1.4.16-b2 or higher)
...
* **11.06.20**
    ...
    - Fixed issue [#106](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/106)
    - Fixed issue [#90](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/90)
...
* **20.12.19**
    ...
    - Fixed issue [#77](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/77)
    - Implemented issue [#75](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/75) (Close Modals With ESC)
...
* **24.11.19**
    ...
    - Improved PPT handler for the web client [#73](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/73)
    
* **06.10.19**
    - Added the possibility to connect within an already running BlackTeaWeb instance
...
* **Client update 1.4.0**
    ...
    - Logging the servers welcome message [#54](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/54)
    - Showing servers hostbutton
    - Fixed microphone and sound action sounds [#67](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/67)
    - Added option to mute clients [#64](https://github.com/BlackTeaSpeak/BlackTeaWeb/issues/64)
...
* **26.01.19**
    - Improved BlackTeaSpeak identities (now generates automatic and are saveable)
...
* **27.02.18**
    - The first public upload of the Web client  
      All BlackTeaSpeak premium & alpha testers have access  
      You require a valid BlackTeaSpeak forum account  