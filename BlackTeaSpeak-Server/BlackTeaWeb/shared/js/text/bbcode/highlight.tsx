...
import '!style-loader!css-loader!highlight.js/styles/dark.css';
    ...
    function: async () => {
        ...
        rendererReact.registerCustomRenderer(new class extends ElementRenderer<BBCodeTagElement, React.ReactNode> {
            ...
            render(element: BBCodeTagElement): React.ReactNode {
                ...
                const requestedLanguage = language === "c-like" ? "c" : language;
                ...
                const detectedLanguage = hljs.getLanguage(requestedLanguage);
                if(detectedLanguage)
