const {TextArea: UrlKnifeTextArea} = require("url-knife/dist/entry.js") as typeof import("url-knife");
...
function bbcodeLinkUrls(message: string, ignore: { start: number, end: number }[]) : string {
    const urls: UrlKnifeUrl[] = UrlKnifeTextArea.extractAllUrls(message, {
        ipV4: true,
        ipV6: false,
        localhost: false,
        intranet: true
