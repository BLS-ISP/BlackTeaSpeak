...
export class Settings {
    ...
    static readonly KEY_I18N_DEFAULT_REPOSITORY: ValuedRegistryKey<string> = {
        ...
        valueType: "string",
        defaultValue: __build.target === "web" ? "i18n" : "https://web.blackteaspeak.de/i18n/"
    };
    ...
    static readonly KEY_TEAFORO_URL: ValuedRegistryKey<string> = {
        key: "teaforo_url",
        defaultValue: __build.target === "web" ? "./" : "https://forum.blackteaspeak.de/",
        valueType: "string",
    };
    ...
    static readonly KEY_RTC_ICE_SERVER_URLS: ValuedRegistryKey<string[]> = {
        key: "rtc_ice_server_urls",
        defaultValue: [],
        requireRestart: true,
        valueType: "object",
        description: "Optional ICE server URL list for WebRTC. Leave empty to use host-only ICE without external STUN/TURN servers."
    };
    ...
    static readonly KEY_UPDATER_LAST_USED_UI: RegistryKey<string> = {
        ...
        valueType: "string",
        description: "Last used BlackTeaSpeak UI version",
    }

    static readonly KEY_UPDATER_LAST_USED_CLIENT: RegistryKey<string> = {
        key: "updater_last_used_client",
        valueType: "string",
        description: "Last used BlackTeaSpeak Client version (TeaClient only)",
    }
