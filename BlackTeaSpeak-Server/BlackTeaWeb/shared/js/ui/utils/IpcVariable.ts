...
import ReactDOM from "../ReactDOMCompat";
...
function savePostMessage(channel: BroadcastChannel | MessageEventSource | undefined | null, message: any) {
...
export class IpcUiVariableProvider<Variables extends UiVariableMap> extends UiVariableProvider<Variables> {
    ...
    constructor() {
        ...
        this.ipcChannelId = "blackteaspeak-ipc-vars-" + guid();
