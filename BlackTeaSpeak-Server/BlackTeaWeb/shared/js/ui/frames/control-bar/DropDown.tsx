...
export class DropdownEntry extends React.PureComponent<React.PropsWithChildren<DropdownEntryProperties>> {
    render() {
...
export class DropdownTitleEntry extends React.PureComponent<React.PropsWithChildren<{}>> {
    render() {
        return (
