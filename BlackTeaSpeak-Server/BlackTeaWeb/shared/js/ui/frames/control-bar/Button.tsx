...
export class Button extends ReactComponentBase<ButtonProperties, ButtonState> {
    private dropdownHideTimeout?: number;
    ...
    private onMouseLeave() {
        this.clearDropdownHideTimeout();
        this.dropdownHideTimeout = window.setTimeout(() => {
    ...
    private clearDropdownHideTimeout() {
        if(typeof this.dropdownHideTimeout !== "number") {
            return;
        }
