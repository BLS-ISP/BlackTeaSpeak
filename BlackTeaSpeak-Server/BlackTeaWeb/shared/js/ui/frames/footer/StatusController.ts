...
export class StatusController {
    ...
    async notifyComponentStatus(component: ConnectionComponent) {
        const isPending = () => this.componentStatusNotifyState[component] === StatusNotifyState.PENDING;
    ...
    async notifyConnectionStatus() {
        const isPending = () => this.connectionStatusNotifyState === StatusNotifyState.PENDING;
