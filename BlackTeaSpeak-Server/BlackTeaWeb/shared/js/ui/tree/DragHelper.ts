...
const kDragDataType = "application/x-blackteaspeak-channel-move";
const kDragHandlerPrefix = "application/x-blackteaspeak-handler-";
const kDragTypePrefix = "application/x-blackteaspeak-type-";
