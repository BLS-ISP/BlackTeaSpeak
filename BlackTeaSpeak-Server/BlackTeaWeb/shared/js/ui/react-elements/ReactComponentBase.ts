...
export abstract class ReactComponentBase<Properties, State> extends React.Component<React.PropsWithChildren<Properties>, State> {
    private update_batch: UpdateBatch;

    private batch_component_id: number;
    private batch_component_force_id: number;

    constructor(props: React.PropsWithChildren<Properties>) {
        super(props);
    ...
    setState<K extends keyof State>(
        state: ((prevState: Readonly<State>, props: Readonly<React.PropsWithChildren<Properties>>) => (Pick<State, K> | State | null)) | (Pick<State, K> | State | null),
        callback?: () => void
    ): void {
