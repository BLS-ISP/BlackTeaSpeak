...
const HelpText2 = () => (
    <HighlightText highlightId={"hs-2"} className={cssStyle.help + " " + cssStyle.paddingTop}>
        <a>
            <Translatable>BlackTeaSpeak Web has three voice activity detection types:</Translatable>
        </a>
        <ol>
            <li>
                <Translatable>
            ...
            <li>
                <Translatable>
                    In this mode, BlackTeaSpeak Web will continuously analyze your microphone input.
