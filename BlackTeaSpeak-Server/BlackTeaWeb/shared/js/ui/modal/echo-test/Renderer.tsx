            ...
            <div className={cssStyle.top}>
                ...
                <div className={cssStyle.help}>
                    ...
                    <ol>
                        ...
                        <li>
                            <h2><Translatable>Nothing worked? Contact support</Translatable></h2>
                            <p>
                                <Translatable>
                                    If still nothing worked, contact the BlackTeaSpeak maintainers and include your browser, device, and microphone details.
                                </Translatable>
                            </p>
                        </li>
                    </ol>
