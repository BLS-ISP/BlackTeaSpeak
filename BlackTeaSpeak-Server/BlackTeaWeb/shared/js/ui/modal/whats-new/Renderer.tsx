    ...
    <div className={cssStyle.body + " " + (!props.visible ? cssStyle.hidden : "")}>
        ...
        {props.list?.url ? (
            <div className={cssStyle.containerBrowse}>
                <a href={props.list.url} target={"_blank"} rel={"noreferrer"}><Translatable>Open full Change Log</Translatable></a>
            </div>
        ) : undefined}
    </div>
);
        ...
        <div className={cssStyle.container}>
            <div className={cssStyle.info}>
                <div className={cssStyle.logo}>
                    <img alt={tr("BlackTeaSpeak logo")} src="img/teaspeak_cup_animated.png"/>
                </div>
