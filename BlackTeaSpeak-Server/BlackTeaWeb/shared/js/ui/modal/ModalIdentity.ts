...
import {BlackTeaSpeakIdentity} from "../../profiles/identities/TeamSpeakIdentity";
import * as tooltip from "../../ui/elements/Tooltip";
import {formatMessage} from "../../ui/frames/chat";
import {tr} from "tc-shared/i18n/localize";
import {LogCategory, logError} from "tc-shared/log";

export function spawnTeamSpeakIdentityImprove(identity: BlackTeaSpeakIdentity, name: string): Modal {
    let modal: Modal;
...
export function spawnTeamSpeakIdentityImport(callback: (identity: BlackTeaSpeakIdentity) => any): Modal {
    let modal: Modal;
    let selected_type: string;
    let identities: { [key: string]: BlackTeaSpeakIdentity } = {};
    ...
    modal = createModal({
        ...
        body: () => {
            ...
            const import_identity = (data: string, ini: boolean) => {
                ...
                BlackTeaSpeakIdentity.import_ts(data, ini).then(identity => {
